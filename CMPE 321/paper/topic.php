...
<div class="container">
    <ul class="nav nav-pills" style="margin-top:30px;">
        ...
        <li class="active"><a href="topic.php">Manage Topic</a></li>
                        ...
                        ?>
                            <tr>
                               <!-- <td><?php echo $row['id'];?></td>-->
                                ...
                                <td><a href="javascript:update('<?php echo $row['id'];?>', 'topic')">update</a> | <a href="javascript:deleteFunc('<?php echo $row['id'];?>', 'topic')">delete</a></td>
                            </tr>
                        <?php
                    }
                }
