<?php
 ...
 if(isset($_POST['keyword'])){
     ...
     $where .= " and paper.title like '%".$_POST['keyword']."%'";
 }
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
    <ul class="nav nav-pills" style="margin-top:30px;">
        ...
        <li><a href="topic2.php">List Topics</a></li>
        <li class="active"><a href="rank2.php">Show Rank</a></li>
    </ul>
    <table class="table" style="margin-top:30px;">
        ...
        <tbody>
            <?php 
                $sql = "select a.*, author.first_name from (select author_id, topic, max(result) as result from paper group by author_id, topic order by result desc) a left join author on a.author_id = author.id";
